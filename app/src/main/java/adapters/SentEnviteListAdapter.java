...
public class SentEnviteListAdapter extends RecyclerView.Adapter<SentEnviteListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load("https://res.cloudinary.com/brees/image/upload/v1648084145/static/header-final_gxcnux.png").into(holder.getCardThumbnailImageView());
        Glide.with(context).load("https://res.cloudinary.com/brees/image/upload/v1648084145/static/header-final_gxcnux.png").into(holder.getCardMediaImageView());
    }
